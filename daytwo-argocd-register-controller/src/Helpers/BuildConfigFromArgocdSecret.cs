...
namespace daytwo.Helpers
{
    public partial class Main
    {
        public static KubernetesClientConfiguration BuildConfigFromArgocdSecret(V1Secret secret)
        {
            ...
            //Globals.log.LogInformation(new EventId(Thread.CurrentThread.ManagedThreadId), "  -        name: " + data["name"]);
            //Globals.log.LogInformation(new EventId(Thread.CurrentThread.ManagedThreadId), "  -      server: " + data["server"]);
